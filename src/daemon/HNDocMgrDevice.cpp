...
#include "HNDocMgrDevicePrivate.h"
...
// Forward declaration
extern const std::string g_HNode2DocMgrRest;

void 
HNDocMgrDevice::defineOptions( OptionSet& options )
{
...
void 
HNDocMgrDevice::handleOption( const std::string& name, const std::string& value )
{
...
int 
HNDocMgrDevice::main( const std::vector<std::string>& args )
{
    ...
    hndEP.setDispatch( "hnode2DocMgr", this );
    hndEP.setOpenAPIJson( g_HNode2DocMgrRest ); 
...
void
HNDocMgrDevice::generateNewHealthState()
{
...
void
HNDocMgrDevice::fdEvent( int sfd )
{
...
void
HNDocMgrDevice::fdError( int sfd )
{
...
void
HNDocMgrDevice::hndnConfigChange( HNodeDevice *parent )
{
...
void 
HNDocMgrDevice::dispatchEP( HNodeDevice *parent, HNOperationData *opData )
{
    std::cout << "HNDocMgrDevice::dispatchEP() - entry" << std::endl;
...
const std::string g_HNode2DocMgrRest = R"(
{
  "openapi": "3.0.0",
  "info": {
    "description": "",
