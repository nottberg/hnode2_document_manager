#ifndef __HN_DOCMGR_DEVICE_PRIVATE_H__
#define __HN_DOCMGR_DEVICE_PRIVATE_H__
...
#define HNODE_TEST_DEVTYPE   "hnode2-docmgr-device"

typedef enum HNDocMgrDeviceResultEnum
{
  HNTD_RESULT_SUCCESS,
  HNTD_RESULT_FAILURE,
...
class HNDocMgrDevice : public Poco::Util::ServerApplication, public HNDEPDispatchInf, public HNDEventNotifyInf, public HNEPLoopCallbacks 
{
    private:
...
#endif // __HN_DOCMGR_DEVICE_PRIVATE_H__
